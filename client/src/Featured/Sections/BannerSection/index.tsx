  ...
  return (
    <section className="mb-6">
      <div className="bg-[#f9fafb] px-[80px] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-[1336px] px-[60px] py-[62px]">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="left">
              <h2 className="bg-[#c1f377] rounded-[28px] px-[17.5px] py-[3.92px] inline-block text-[14px] font-semibold mb-[16px]">
                New Trend 2025
              </h2>
      ...
      <div className="container mx-auto max-w-[1336px] px-[60px] pt-[60px] flex items-center flex-col gap-[60px]">
        <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 justify-between w-full">
          <div className="box flex items-center gap-[12px]">
            <div className="img">
              <svg
                width="2.8125em"
                height="2.25em"
            ...
            <div className="body">
              <h2 className="font-semibold text-[1.125em] leading-[140%]">
                Free Shipping
              </h2>
              <h3 className="text-[#667085] text-[14px] leading-[160%] w-[200px]">
